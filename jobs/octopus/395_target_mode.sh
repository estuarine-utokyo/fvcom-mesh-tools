...
#PBS -N fmesh_396
#PBS -j o
#PBS -o logs/396_target_mode.pbs.log
#PBS -r n
#============================================================================
...
pids=()
run_variant field    "SR_H_TARGET=field" & pids+=($!)
run_variant achieved "SR_H_TARGET=achieved" & pids+=($!)
run_variant ach1w    "SR_H_TARGET=achieved SR_ONE_WIDE=allow" & pids+=($!)
status=0
