"""PoC #130 (stage 1) — M2 tide case for the v5 pipeline mesh.
...
MESH = REPO / "outputs" / "pipeline_v6r" / "tokyo_bay_v6_final.14"
V2_INPUTS = REPO / "outputs" / "pipeline_v6r" / "fvcom_inputs"
TIDE_NML = REPO / "outputs" / "fvcom_tide_v4" / "tokyo_bay_v4_tide_run.nml"
CASE_DIR = REPO / "outputs" / "fvcom_tide_v6"
CASENAME = "tokyo_bay_v6_tide"
...
def main() -> int:
    ...
    for f in V2_INPUTS.glob("tokyo_bay_v6_*.dat"):
    ...
    dep_case = CASE_DIR / "input" / "tokyo_bay_v6_dep.dat"
    ...
    txt = txt.replace("tokyo_bay_v4", "tokyo_bay_v6")
