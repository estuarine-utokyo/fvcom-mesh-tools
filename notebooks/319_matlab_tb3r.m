...
addpath('../data');  % Add Tokyo Bay regional data to path
addpath('../../utilities/shapefile');  % Add shapefile utilities for safe_geodata
addpath('../data/Futtsu_coastline');  % Add Futtsu coastline subdirectory
...
if ~exist('../outputs/meshes', 'dir')
    mkdir('../outputs/meshes');
end

% Setup output directories
outdir = fullfile('..', 'outputs', 'PNG');
meshdir = fullfile('..', 'outputs', 'meshes');
