"""PoC #59i (stage 3) — validate the tokyo_bay_v2 M2 tidal run.
...
OUT_NC = REPO / "outputs" / "fvcom_tide" / "output" / "tokyo_bay_v2_tide_0001.nc"
VERDICT = REPO / "outputs" / "fvcom_tide" / "59i_tide_verdict.json"
FIG = REPO / "outputs" / "figures" / "59i_m2_amplitude.png"
...
def main() -> int:
    ...
    print(f"[59i] wrote {FIG}", flush=True)
